...
=== כללי תוכן ===
- הצע בדיוק 5 יעדים שונים זה מזה (מדינות/אזורים שונים)
...
{"destinations":[{"name":"...","country":"...","description":"...","whyItFits":"...","matchScore":80,"climate":"...","highlights":["...","...","..."]}, ... (5 סה"כ)]}`;
  ...
  if (filtered.length < 3) {
    console.warn(`[AI] נשארו רק ${filtered.length} יעדים אחרי סינון — מחזיר מה שיש`);
  }

  // החזר את ה-3 הטובים ביותר לפי matchScore
  return filtered
